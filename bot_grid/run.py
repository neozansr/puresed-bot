...
def run_bot(config_system, config_params, config_params_path, last_loop_path, transfer_path, open_orders_df_path, transactions_df_path, error_log_df_path, cash_flow_df_path):
    ...
    if cont_flag == 1:
        cont_flag = check_cut_loss(exchange, bot_name, config_system, config_params, last_loop_path, transfer_path, open_orders_df_path, error_log_df_path, cash_flow_df_path)
